...
CREATE TABLE `sys_notice` (
  ...
  `classification` varchar(20) DEFAULT 'ALL' COMMENT '分类: TEACHING-教学, RESEARCH-科研, ALL-全部',
...
CREATE TABLE `biz_project` (
  ...
  `classification` varchar(20) NOT NULL COMMENT '大类: TEACHING(教学类), RESEARCH(科研类)',
